...
export default class extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.boolean('has_agreed_to_standard_savings_terms').defaultTo(false)
      table.boolean('has_agreed_to_vault_savings_terms').defaultTo(false)
      table.boolean('has_agreed_to_dollar_savings_terms').defaultTo(false)
      table.boolean('has_agreed_to_target_savings_terms').defaultTo(false)
